// import QuaCau from "../../img/QuaCau.jpg";
const data = [
  {
    image:
  ...
  },
  {
    ...
    caption: "Xếp hình",
    description:
      "Trò chơi này là bạn cần di chuyển các khối đã cho và đặt nó vào sân chơi, khi bạn điền vào một hàng hoặc một cột, tất cả các khối trong hàng hoặc cột này sẽ bị xóa. ",
  },
  // {
  //   image:
